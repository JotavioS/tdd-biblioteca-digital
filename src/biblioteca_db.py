...
from src.models import LivroModel, UsuarioModel, EmprestimoModel
...
class BibliotecaDB:
    ...
    def devolver_livro(self, livro_id: str, usuario_id: str) -> bool:
        ...
        emprestimo = self.db.query(EmprestimoModel).filter(
    ...
    def listar_emprestimos_ativos(self):
        ...
        return self.db.query(EmprestimoModel).filter(EmprestimoModel.data_devolucao.is_(None)).all()